...
```
{
  "http://schema.org/url": "https://www.openagrar.de/receive/openagrar_mods_00092233"
}
```

#### 2.1.12 Spatial coverage
**Definition:** "The spatialCoverage of a Dataset indicates the place(s) which are the focus of the content." (Definition changed from Schema.org "[http://schema.org/spatialCoverage](http://schema.org/spatialCoverage)")
**Cardinality:** 0-n
**Range:** Place
...
#### 2.1.18 Update date
**Definition:** "The date on which the Dataset was most recently modified or when the item's entry was modified " (Definition changed from [http://schema.org/dateModified](http://schema.org/dateModified))
**Cardinality:** 0-1
**Range:** Date or DateTime (ISO 8601)
...
#### 2.1.22 Has part
**Definition:** "Indicates a Dataset or CreativeWork that is part of this item." (Definition changed from [http://schema.org/hasPart](http://schema.org/hasPart))
**Cardinality:** 0-n
...
```
#### 2.1.23 Is part of
**Definition:** "Indicates a Dataset or CreativeWork that this item." (Definition changed from [http://schema.org/isPartOf](http://schema.org/isPartOf))
**Cardinality:** 0-n
**Range:** Dataset/CreativeWork
...
#### 2.1.24 Is based on
**Definition:** "A resource from which this Dataset is derived or from which it is a modification or adaptation. " (Definition changed from [http://schema.org/isBasedOn](http://schema.org/isBasedOn))
**Cardinality:** 0-n
**Range:** Dataset/CreativeWork
...
#### 2.1.25 Access type
**Definition:** "A flag to signal that the item, event, or place is accessible for free." (Definition taken from [http://schema.org/isAccessibleForFree](http://schema.org/isAccessibleForFree))
**Cardinality:** 0-1
**Range:** Boolean
...
**Person definition:** A person (alive, dead, undead, or fictional). (Definition taken from [http://schema.org/Person](http://schema.org/Person))

**Organization definition:** An organization such as a school, NGO, corporation, club, etc. (Definition taken from [http://schema.org/Organization](http://schema.org/Organization))
...
### 2.4 DefinedTerm
**Definition:** "A word, name, acronym, phrase, etc. with a formal definition. Often used in the context of category or subject classification, glossaries or dictionaries, product or creative work types, etc." (Definition taken from [http://schema.org/DefinedTerm](http://schema.org/DefinedTerm))
...
**Definition:** "A description/definition of the DefinedTerm. " (Definition changed from [http://schema.org/description](http://schema.org/description))
**Cardinality:** 0-1
**Range:** Text
...
#### 2.4.4 Code
**Definition:** "A code that identifies a term within a terminology." (Definition changed from [http://schema.org/termCode](http://schema.org/termCode))"
**Cardinality:** 0-1
**Range:** Text
...
```
### 2.5 DataCatalog
**Definition:** "A collection of datasets, e.g. a Research Data Infrastructure." (Definition changed from [http://schema.org/DataCatalog](http://schema.org/DataCatalog))
...
### 2.6 CreativeWork
**Definition:** "The most generic kind of creative work, including books, movies, photographs, software programs, etc." (Definition taken from [http://schema.org/CreativeWork](http://schema.org/CreativeWork) )
...
### 2.7 Place
**Definition:** "Entities that have a somewhat fixed, physical extension." (Definition taken from [http://schema.org/Place](http://schema.org/Place))
...
#### 2.7.3 Bounding box
**Definition:** "A box is the area enclosed by the rectangle formed by two points. The first point is the lower corner, the second point is the upper corner. A box is expressed as two points separated by a space character." (Definition taken from [http://schema.org/box](http://schema.org/box))
**Cardinality:** 1
**Range:** Text
...
- For each property constructed via [additionalProperty](http://schema.org/additionalProperty), following properties are possibly used to define it:
