...
title: '"insert type/entity name please"'
labels: suggest, type/entity
assignees: ''
...
**What are the important properties to describe the type/entity you are suggesting?**
Each type/entity has a list of properties to describe them. Please list the most important ones for the suggested type.
